      ...
      <div className="container">
        <div className="grid gap-12 md:grid-cols-[0.8fr_1.2fr] md:gap-16">
          ...
          <div className="space-y-5 text-balance text-base leading-relaxed text-ink-light dark:text-paper/70">
            <p>
              {domainName} is a simple way for small business owners to put their shop online without
            ...
            <p>
              We built {domainName} especially for small businesses: local boutiques, home bakers,
